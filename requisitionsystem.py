requisition_counter = 10000 # to generate a unique requsition ID every time a new requsition is created.

class RequisitionSystem:
    requisitions = [] # List to store all the requsition items.
